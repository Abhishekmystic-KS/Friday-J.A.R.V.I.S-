...
This is a voice assistant project with voice wake-word detection, STT, LLM, and TTS.
...
- [src/jarvis/ui/robo_popup.py](src/jarvis/ui/robo_popup.py) — robo popup animation UI
